...
const NODES = [
  { id: "N1", label: "Language & Intent Normalizer", model: "gemini-2.0-flash", executor: "gemini", desc: "Detects language, normalizes to Devanagari + canonical English, flags ambiguities." },
  { id: "N2", label: "Risk Tier Gate", model: "gemini-2.0-flash", executor: "gemini", desc: "Classifies TIER_0 / TIER_1 / TIER_2. TIER_0 halts the pipeline." },
  ...
  { id: "N5", label: "Grounded Answerer", model: "gemini-2.0-flash", executor: "gemini", desc: "Answers each claim from evidence only. No evidence, no answer." },
  ...
  { id: "N8", label: "Synthesizer", model: "gemini-2.0-flash", executor: "gemini", desc: "Composes the final response in the user's language, from verified claims only." },
  { id: "N9", label: "Back-Translation Fidelity Check", model: "gemini-2.0-flash", executor: "gemini", desc: "Translates the answer back to English to catch drift. One retry on failure." },
];
